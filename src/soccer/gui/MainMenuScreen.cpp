	...
	: Screen(sm)
{
	...
	addButton("Friendly",      Rectangle(0.35f, 0.35f, 0.30f, 0.07f));
	addButton("Preset League", Rectangle(0.35f, 0.45f, 0.30f, 0.07f));
	addButton("Preset Cup",    Rectangle(0.35f, 0.55f, 0.30f, 0.07f));
